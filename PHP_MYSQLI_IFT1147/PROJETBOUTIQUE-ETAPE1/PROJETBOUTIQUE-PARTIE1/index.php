...
<head>
  ...
  <!-- FAVICON -->
  <link href="client/public/img/favicon.png" rel="shortcut icon">
  <!-- PLUGINS CSS STYLE -->
  <!-- <link href="plugins/jquery-ui/jquery-ui.min.css" rel="stylesheet"> -->
  <!-- Bootstrap -->
  <link rel="stylesheet" href="client/utilitaires/plugins/bootstrap/css/bootstrap.min.css">
  <link rel="stylesheet" href="client/utilitaires/plugins/bootstrap/css/bootstrap-slider.css">
  <!-- Font Awesome -->
  <link href="client/utilitaires/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet">
  <!-- Owl Carousel -->
  <link href="client/utilitaires/plugins/slick-carousel/slick/slick.css" rel="stylesheet">
  <link href="client/utilitaires/plugins/slick-carousel/slick/slick-theme.css" rel="stylesheet">
  <!-- Fancy Box -->
  <link href="client/utilitaires/plugins/fancybox/jquery.fancybox.pack.css" rel="stylesheet">
  <link href="client/utilitaires/plugins/jquery-nice-select/css/nice-select.css" rel="stylesheet">
  <!-- CUSTOM CSS -->
			...
			<div class="col-md-12">
				<nav class="navbar navbar-expand-lg navbar-light navigation">
					<a class="navbar-brand" href="index.php">
						<img src="client/public/images/logo.png" alt="">
					</a>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav ml-auto main-nav ">
							...
							<li class="nav-item dropdown dropdown-slide">
								<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="">tableau de bord<span><i class="fa fa-angle-down"></i></span>
								</a>

								<!-- Dropdown list -->
								<div class="dropdown-menu">
									<a class="dropdown-item" href="client/pages/dashboard.html">tableau de bord</a>
									<a class="dropdown-item" href="client/pages/dashboard-my-ads.html">Mes annonces</a>
									<a class="dropdown-item" href="client/pages/dashboard-favourite-ads.html">Annonces preferees</a>
									<a class="dropdown-item" href="client/pages/dashboard-archived-ads.html">Annonces archivees</a>
									<a class="dropdown-item" href="client/pages/dashboard-pending-ads.html">Annonces en attente</a>
								</div>
							</li>
							<li class="nav-item dropdown dropdown-slide">
								...
								<!-- Dropdown list -->
								<div class="dropdown-menu">
									<a class="dropdown-item" href="client/pages/about-us.html">A propos de nous</a>
									<a class="dropdown-item" href="client/pages/contact-us.html">Contacter nous</a>
									<a class="dropdown-item" href="client/pages/user-profile.html">Profil</a>
									<a class="dropdown-item" href="client/pages/blog.html">Blog</a>

								</div>
							</li>
							<li class="nav-item dropdown dropdown-slide">
								<a class="nav-link dropdown-toggle" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									referencement <span><i class="fa fa-angle-down"></i></span>
								</a>
								<!-- Dropdown list -->
								<div class="dropdown-menu">
									<a class="dropdown-item" href="client/pages/category.html">Ajouter une grille </a>
									<a class="dropdown-item" href="client/pages/ad-listing-list.html">Ad-List View</a>
								</div>
							</li>
						</ul>
						<ul class="navbar-nav ml-auto mt-10">
							<li class="nav-item">
								<a class="nav-link login-button" href="client/pages/login.html">Connexion</a>
							</li>
							<li class="nav-item">
								<a class="nav-link text-white add-button" href="client/pages/ad-listing.html"><i class="fa fa-plus-circle"></i> Ajouter une liste</a>
							</li>
						</ul>
					</div>
				</nav>
...
<!-- JAVASCRIPTS -->
<script src="client/utilitaires/plugins/jQuery/jquery.min.js"></script>
<script src="client/utilitaires/plugins/bootstrap/js/popper.min.js"></script>
<script src="client/utilitaires/plugins/bootstrap/js/bootstrap.min.js"></script>
<script src="client/utilitaires/plugins/bootstrap/js/bootstrap-slider.js"></script>
  <!-- tether js -->
<script src="client/utilitaires/plugins/tether/js/tether.min.js"></script>
<script src="client/utilitaires/plugins/raty/jquery.raty-fa.js"></script>
<script src="client/utilitaires/plugins/slick-carousel/slick/slick.min.js"></script>
<script src="client/utilitaires/plugins/jquery-nice-select/js/jquery.nice-select.min.js"></script>
<script src="client/utilitaires/plugins/fancybox/jquery.fancybox.pack.js"></script>
<script src="client/utilitaires/plugins/smoothscroll/SmoothScroll.min.js"></script>
<!-- google map -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCcABaamniA6OL5YvYSpB3pFMNrXwXnLwU&libraries=places"></script>
<script src="client/utilitaires/plugins/google-map/gmap.js"></script>
